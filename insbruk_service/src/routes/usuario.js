...
usuario_router.post('/registrar', validarAdmin, usuario_controller.registrarUsuario);
...
usuario_router.post('/matricular', validarAdminAndProfe, usuario_controller.matricularUsuario);
